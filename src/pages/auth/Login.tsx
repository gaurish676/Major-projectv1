...
export const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col justify-between text-slate-100 p-4 sm:p-6 lg:p-8 relative">
      ...
      {/* Top Header */}
      <div className="max-w-5xl mx-auto w-full flex items-center justify-between py-2 border-b border-slate-900 pb-3">
        ...
        <div className="hidden sm:flex items-center gap-2 bg-slate-900 px-3 py-1.5 rounded-full border border-slate-800 text-[11px] text-slate-300">
      ...
      <div className="max-w-md mx-auto w-full my-auto py-8">
        <div className="bg-slate-900/90 backdrop-blur-md rounded-2xl p-6 sm:p-8 border border-slate-800 shadow-2xl space-y-5">
          ...
          <form onSubmit={handleLoginSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full pl-9 pr-3 py-2.5 text-xs bg-slate-950 border border-slate-800 rounded-xl text-white placeholder:text-slate-600 focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 outline-hidden transition"
                />
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full pl-9 pr-10 py-2.5 text-xs bg-slate-950 border border-slate-800 rounded-xl text-white placeholder:text-slate-600 focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 outline-hidden transition"
                />
            ...
            <button
              ...
              className="w-full py-2.5 px-4 rounded-xl text-xs font-bold bg-indigo-600 hover:bg-indigo-700 text-white shadow-md shadow-indigo-600/30 flex items-center justify-center gap-2 transition cursor-pointer disabled:opacity-50"
            >
              {isSubmitting ? (
            ...
            <div className="pt-3 border-t border-slate-800/80 space-y-2">
              ...
              <div className="grid grid-cols-3 gap-1.5 text-[11px]">
                <button
                  ...
                  className="p-2 rounded-xl bg-slate-950 hover:bg-slate-800 border border-slate-800 hover:border-indigo-500/50 text-slate-300 hover:text-indigo-300 transition text-center cursor-pointer disabled:opacity-50 group flex flex-col items-center justify-center min-h-[48px]"
                ...
                <button
                  ...
                  className="p-2 rounded-xl bg-slate-950 hover:bg-slate-800 border border-slate-800 hover:border-purple-500/50 text-slate-300 hover:text-purple-300 transition text-center cursor-pointer disabled:opacity-50 group flex flex-col items-center justify-center min-h-[48px]"
                ...
                <button
                  ...
                  className="p-2 rounded-xl bg-slate-950 hover:bg-slate-800 border border-slate-800 hover:border-amber-500/50 text-slate-300 hover:text-amber-300 transition text-center cursor-pointer disabled:opacity-50 group flex flex-col items-center justify-center min-h-[48px]"
